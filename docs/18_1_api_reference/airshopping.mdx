...
````xml
 ...
 | -------- | ------- | ------- |
 | `<PointOfSale>`  | AirShoppingRQ request information with O&D and Passenger details.    |Yes|
 | `<FlightRelatedCriteria>` | Preferred or required criteria for flight filters from the shopping response.     |No|
 | `<FlightCriteria>`    | Preferred or required criteria for flight filters from the shopping response.    |Yes|
 | `<FlightRequest>`    | This is the flight request.|Yes|
 ### Response Format
